...
Notre toute jeune association wavedoctors est née de nos passions communes : la médecine et les sports aquatiques en plein air comme le surf, la voile, la plongée etc...
...
Proposer des des dispositifs prévisionnels de secours (DPS) pour tout type d´événements.        </div>
      </div>
    </div>
  )
}
